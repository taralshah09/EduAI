          ...
          <div className="grid grid-cols-12 gap-6 bento-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '1.5rem' }}>
            ...
            <div className="col-span-12 lg:col-span-8 flex flex-col gap-8">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-7xl font-extrabold text-dark leading-[0.9] tracking-[-0.05em] uppercase">
                  REVOLUTIONIZE <br />
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-2">
                    <span>LEARNING</span>
                    <span className="inline-block px-4 md:px-6 py-1 md:py-2 border border-gray-300 rounded-full text-sm md:text-2xl font-normal lowercase tracking-normal italic">with</span>
            ...
            <div className="col-span-12 lg:col-span-4 bg-dark rounded-[24px] p-8 text-white relative overflow-hidden flex flex-col justify-between min-h-[300px]">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-dark bg-gray-600 flex items-center justify-center text-[10px] font-bold">
                      U{i}
                    </div>
                  ))}
                  <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-[10px] text-dark font-black">+12</div>
                </div>
              </div>
              <div className="absolute bottom-0 right-0 w-48 h-48 bg-gradient-to-tr from-primary/10 to-transparent rounded-full -mb-10 -mr-10 blur-2xl"></div>
            </div>
            ...
            <div className="col-span-12 md:col-span-4 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-dark p-8 rounded-[24px] text-white text-center">
              ...
              <div className="bg-white border-[1.5px] border-gray-200 rounded-[24px] p-6 relative overflow-hidden group">
                <div className="relative z-10 flex justify-between items-start mb-6">
                  <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
                    <svg width="24" height="24" className="w-6 h-6 text-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="col-span-12 md:col-span-8 bg-primary rounded-[24px] p-8 md:p-10 flex flex-col justify-between group">
              <div className="space-y-6">
                <div className="flex flex-wrap gap-2">
                  <span className="px-4 py-1.5 rounded-full bg-dark text-white text-[10px] font-bold uppercase tracking-widest">Modules Ready</span>
                  <span className="px-4 py-1.5 rounded-full border border-dark/20 text-dark text-[10px] font-bold uppercase tracking-widest">Takeaways Generated</span>
                  <span className="px-4 py-1.5 rounded-full border border-dark/20 text-dark text-[10px] font-bold uppercase tracking-widest">AI Quiz</span>
                </div>
                <div className="space-y-4">
                  <h2 className="text-4xl md:text-6xl font-black text-dark tracking-tighter">Flexible</h2>
                  <div className="h-[1.5px] bg-dark/10 w-full"></div>
                  <div className="space-y-4 mt-6">
                    <div className="bg-white/40 border border-dark/5 p-4 rounded-2xl flex items-center justify-between hover:bg-white/60 transition-all cursor-pointer">
                      <div className="flex items-center gap-4">
                        <div className="w-8 h-8 rounded-full bg-dark text-white flex items-center justify-center font-bold text-xs">01</div>
                        <span className="font-bold text-dark">Introduction to Neural Networks</span>
                      </div>
                      <svg width="20" height="20" className="w-5 h-5 text-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="bg-dark text-white p-6 rounded-2xl">
                      <div className="flex justify-between items-start mb-4">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Key Takeaways</span>
                      </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mt-12 gap-6">
                ...
                <div className="w-20 h-20 bg-dark rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform self-end">

    ...
    <div className="min-h-screen bg-[#f3f4f6] flex flex-col font-sans">
      ...
      <main className="flex-grow p-6 md:p-10 w-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          <div>
            <h1 className="text-5xl md:text-6xl font-black text-[#111827] uppercase tracking-tighter leading-none mb-2">My Library</h1>
          ...
          <Link 
            to="/" 
            className="group bg-[#d9f99d] text-[#111827] font-black px-8 py-4 rounded-full uppercase tracking-tighter text-sm hover:brightness-105 transition-all shadow-lg flex items-center gap-3"
          >
            <span>+ New Course</span>
            <div className="w-8 h-8 rounded-full bg-[#111827] flex items-center justify-center text-white scale-75 group-hover:scale-100 transition-transform">
        ...
        {/* Processing Banner */}
        {hasProcessing && (
          <div className="bg-[#111827] text-white p-4 rounded-3xl mb-12 flex items-center gap-4 animate-in fade-in slide-in-from-top-2">
            <div className="w-6 h-6 border-2 border-[#d9f99d]/20 border-t-[#d9f99d] rounded-full animate-spin"></div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#d9f99d]">Building your courses in the background...</p>
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="bg-white border-2 border-dashed border-gray-200 p-20 rounded-[48px] text-center group hover:border-[#d9f99d] transition-colors cursor-pointer" onClick={() => navigate('/')}>
             ...
             <h3 className="text-2xl font-black text-[#111827] uppercase tracking-tighter mb-2">No courses yet</h3>
             ...
             <Link to="/" className="inline-block bg-[#111827] text-white px-10 py-4 rounded-full font-bold uppercase tracking-widest text-xs">Generate your first course</Link>
          </div>
        ) : (
